...
@Composable
fun MyNavigation(context:Context, segregatedViewModel: SegregatedViewModel, notSegregatedViewModel: NotSegregatedViewModel, individualHouseViewModel: IndividualHouseViewModel, ){
