...
@Composable
fun SegregatedDataScreen(navController: NavHostController){
    ...
    Scaffold(
        ...
        Column(
            ...
            SegregatedDataScreenComponent()
        }
    }
}
@Composable
fun SegregatedDataScreenComponent(){

    val viewModel: RoomDatabaseViewModel = viewModel()
    val segregatedData = viewModel.getSegregatedDataSortedById().observeAsState(initial = emptyList()).value

    Column(
        modifier = Modifier
            .background(Color(0XFFE6EDf5)),
    ) {
        if (segregatedData.isNotEmpty()) {
            LazyColumn(
                modifier = Modifier
                    .fillMaxWidth()
...
@Composable
fun DataShowing(data: SegregatedDataEntity,viewModel: RoomDatabaseViewModel) {
    ...
    Card(
        ...
        Icon(
            ...
            modifier = Modifier
                ...
                .clickable { viewModel.deletesegregatedData(data.primaryKey) }
        )
    }
}
